...
MariaDB [csd2204s18]> select  salary from eployees where last_name like 'BULL';
ERROR 1146 (42S02): Table 'csd2204s18.eployees' doesn't exist
...
ERROR 1064 (42000): You have an error in your SQL syntax; check the manual that corresponds to your MariaDB server version for the right syntax to use near 'SELECT AVG(SALARY) FROM EMPLOYEES and department_id in ( select department_id fr' at line 1
MariaDB [csd2204s18]> select first_name, last_name,salary,department_id from employees where salary > (SELECT AVG(SALARY) FROM EMPLOYEES) and department_id in ( select department_id from departments where department_name like 'IT%');
+------------+-----------+---------+---------------+
